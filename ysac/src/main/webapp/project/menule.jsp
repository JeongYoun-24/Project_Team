               ...
               <!--  <div class="additional_description_translated">
                ...
                <div class="accordion accordion-flush" id="accordionFlushExample">
                    ...
                    <div class="row mt-2">
                        ...
                        <input type="number" id="pro_qty2" max="999" min="1" placeholder="1" value="1">
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="row">
                    ...
                    <div class="col-6 ">
                        <button type="button" class="btn btn-dark btn-lg" id="orderBtn" >구매하기</button>
                    </div>
                </div>
            </div> 
        </div>
...
$(function () {
	...
	'"}'
			...
			$.ajax({  //페이지가 아닌 데이터만 보내기
				...
				if(jsonMessage.code === "idError"){
					alert('로그인후 이용가능');
					location.href="${ctxPath}/users/usersLogin"
				
				}else if(jsonMessage.code ==='qty'){	
					alert('재고량 초과했습니다.');
					//location.href="${ctxPath}/users/usersLogin"
				}else if(jsonMessage.code ==='ok'){
					alert('장바구니에 추가되었습니다.');
...
$(function () {
	$('#orderBtn').click(function() {
		...
		if(${loginInfo != null}){
			location.href="${ctxPath}/order/insert?product_code=${proList.product_code}&pro_qty="+pro_qty;
