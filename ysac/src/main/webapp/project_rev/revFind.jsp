        ...
        <div class="container">
               ...
               <div class="container m-auto">
                  <table class="table table-bordered">
                    <thead>
                     	<tr> 
                          <th scope="col" width="10%">리뷰 번호</th>
                            ...
                            <table class="table table-bordered ">
                              <thead>
                                 <tr>
                                  ...
                                  <c:choose>
                                  	<c:when test="${revfind.rev_code-1 ==0}">
                                  		이전글 없음
                                  	</c:when>
                                  <c:otherwise>
                                  <a href="${ctxPath}/rev/revFind.do?rev_code=${revfind.rev_code-1}">${revfind.rev_code-1}</a>
                                  </c:otherwise>
                                ...
                                <tr>
                                  ...
                                  <th scope="col" width="70%">
                                   <c:choose>
                                  	<c:when test="${revfind.rev_code+1 > revfind.rev_code}">
                                  		다음글 없음
                                  	</c:when>
                                  <c:otherwise>
                                  <a href="${ctxPath}/rev/revFind.do?rev_code=${revfind.rev_code+1}">${revfind.rev_code+1}</a>
